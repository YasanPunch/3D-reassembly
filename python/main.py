...
class AppWindow:
    ...
    def __init__(self, width, height):
        ...
        w.add_child(self._pcprocessing_panel)
        ...
        if gui.Application.instance.menubar is None:
            ...
            settings_menu.add_item(
                "Point Cloud Processing", AppWindow.MENU_SHOW_PCPROCESSING
            )
            settings_menu.set_checked(AppWindow.MENU_SHOW_PCPROCESSING, True)
            help_menu = gui.Menu()
        ...
        w.set_on_menu_item_activated(
            AppWindow.MENU_SHOW_PCPROCESSING, self._on_menu_toggle_pcprocessing_panel
        )
    ...
    def _on_layout(self, layout_context):
        ...
        height = min(
            r.height,
            self._pcprocessing_panel.calc_preferred_size(
                layout_context, gui.Widget.Constraints()
            ).height,
        )
        self._pcprocessing_panel.frame = gui.Rect(
    ...
    def _on_menu_toggle_pcprocessing_panel(self):
        self._pcprocessing_panel.visible = not self._pcprocessing_panel.visible
        gui.Application.instance.menubar.set_checked(
            AppWindow.MENU_SHOW_PCPROCESSING, self._pcprocessing_panel.visible
        )
